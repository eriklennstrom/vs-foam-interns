...
onBeforeMount(() => {
  iconMixin.verifyColor(props.color) ? null : iconColor.value = "primary"
  iconMixin.verifyVariant(iconName.value) ? iconName.value = 'fa-' + iconName.value : iconName.value = "fa-warning"
})
