...
export default {
  ...
  const Template: StoryFn<typeof FoamDropdownInput> = (args) => ({
    ...
    <div style="display: flex; gap: 24px; flex-direction: row;" >
        <foam-dropdown role="button" variant="primary"  text="Countries"  >
        ...
        <foam-dropdown role="button" variant="primary" text="Navigation"  >
            ...
            <foam-dropdown-item text="Socials"  subdropdown>
              <foam-dropdown-item text="Facebook" />
              <foam-dropdown-item text="Instagram" />
              <foam-dropdown-item text="GitHub" />
            </foam-dropdown-item>
        </foam-dropdown>
    </div>
    `
